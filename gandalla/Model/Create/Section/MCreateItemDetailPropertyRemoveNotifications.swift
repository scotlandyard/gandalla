...
class MCreateItemDetailPropertyRemoveNotifications:MCreateItemDetailProperty
{
    ...
    {
        let name:String = NSLocalizedString("MCreateItemDetailPropertyRemoveNotifications_name", comment:"")
